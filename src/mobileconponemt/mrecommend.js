                    ...
                    return (
                        <li key={item.name}>
                            <div className="Mrec-muc">
                                ...
                                <NavLink to={`/admin/mdetail?id=${item.id}`} className="Mcover"></NavLink>
                                <div className="Mrec-icon">
                                    ...
                                    <NavLink to={`/admin/mdetail?id=${item.id}`} className="Mp-icon"></NavLink>
                                </div>
                                <p className="Mrec-mucTxt">
                                    <NavLink to={`/admin/mdetail?id=${item.id}`}>
                                        {item.name}
                                    </NavLink>
                                </p>
                            </div>
